package com.example.user.androidhive.utils;
...
public class BitmapUtils {
    ...
    public static Bitmap getBitmapFromAssets(Context context, String fileName, int width, int height) {
        ...
        Bitmap bitmap = null;
        try {
            final BitmapFactory.Options options = new BitmapFactory.Options();  //  BitmapFactory 의 options 객체
            options.inJustDecodeBounds = true;

            istr = assetManager.open(fileName); // 인풋스트림 객체 istr assetManager.
